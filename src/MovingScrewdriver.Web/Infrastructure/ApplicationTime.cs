...
namespace MovingScrewdriver.Web.Infrastructure
{
    ...
    {
        private static readonly Func<DateTimeOffset> _defaultLogic =
              () => DateTimeOffset.UtcNow;

        private static Func<DateTimeOffset> _current = _defaultLogic;

        /// <summary>
        /// Returns current date/time, correct in application context
        /// </summary>
        /// <remarks>Normally this would return <see cref="DateTimeOffset.UtcNow" />
        ...
        public static void _replaceCurrentTimeLogic(Func<DateTimeOffset> newCurrentTimeLogic)
        {
